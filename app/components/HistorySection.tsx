...
const historyData: Record<number, YearData> = {
  2018: {
    선정: ['동아리 창립'],
    교육: ['보안 기초 커리큘럼 운영', 'Linux 스터디'],
    발표: ['창립 세미나 개최'],
    논문: ['-'],
  },
  2022: {
    선정: ['KUSIC 선정'],
    교육: ['TeamH4C 백곰팟 수료', 'BoB', 'WhiteHat School 2nd'],
    발표: ['OB 특강 (장동근, 김오성)', '2022 KUSIC 세미나'],
    논문: ['2022 동계 한국통신학회'],
  },
  2023: {
    선정: ['KUSIC 우수 동아리 선정'],
    교육: ['보안 커리큘럼 강화', 'CTF 팀 구성'],
    발표: ['교내 보안 세미나', '해킹 실습 워크숍'],
    논문: ['2023 하계 한국통신학회'],
  },
  2024: {
    선정: ['KUSIC 선정'],
    교육: ['TeamH4C 백곰팟 수료', 'BoB', 'WhiteHat School 2nd'],
    발표: ['OB 특강 (장동근, 김오성)', '2024 KUSIC 관덕별 세미나', '제 1회 스보반의 날'],
    논문: ['2024 동계 한국통신학회'],
  },
  2025: {
    선정: ['KUSIC 선정 (예정)'],
...
const cardTitles: (keyof YearData)[] = ['선정', '교육', '발표', '논문']
